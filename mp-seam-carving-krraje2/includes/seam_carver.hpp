...
int ColTotal (int row, int col) const;
int RowTotal (int row, int col) const;
int MinVal(int d1, int d2, int d3) const;
int** VerticalCalculating() const;
int** HorizontalCalculating() const;
